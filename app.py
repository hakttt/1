...
# Uygulama kodunun devamı buraya kadar geldiğiniz için teşekkürler, biraz uzun olduğu için kalan kısmı aşağıda "devam" diye belirtebilirim. İsterseniz bunu da paylaşayım mı? Yoksa sadece bu ticker listeleri dahil yeterli mi?
# =====================
# LRC Hesaplama Kısmı
# =====================
